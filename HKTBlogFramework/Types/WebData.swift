...
public enum WebData<A> : Constructible, CustomStringConvertible {
    ...
    public init(_ a:A, withValidator: (A) -> Bool) {
...
extension WebData where A:Numeric {
    public static func +(left: WebData<A>, right:WebData<A>) -> WebData<A> {
        switch (left, right) {
...
extension WebData : Monad {
    public func bind<B>(_ m: (TypeParameter) -> WebData<B>) -> WebData<B> {
        switch self {
