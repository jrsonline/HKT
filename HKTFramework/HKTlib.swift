...
public protocol DualConstructible : Constructible {
...
public struct Construct<ConstructorTag : HKTTag, TypeParameter>  {
    ...
    public let tag: ConstructorTag
    
    public init(tag: ConstructorTag) {
        self.tag = tag
    }
}
...
extension Sequence {
    public var first : Element?  { get { return self.first(where: {_ in true}) } }
}
